...
from formatters import (
    format_workflow_run, format_workflow_job, format_check_run, format_check_suite,
    get_status_color, get_status_icon, calculate_duration
)
...
class TestFormatters(unittest.TestCase):
    ...
    def test_get_status_color(self):
        ...
        self.assertEqual(get_status_color("completed", "success"), discord.Color.green())
        self.assertEqual(get_status_color("completed", "failure"), discord.Color.red())
        self.assertEqual(get_status_color("completed", "cancelled"), discord.Color.light_grey())
